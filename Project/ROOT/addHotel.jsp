				...
				<DIV class="container">
					...
					<DIV class="collapse navbar-collapse navHeaderCollapse">
						...
						<UL class="nav navbar-nav navbar-left">
							...
							<LI class=""><a href="/CSPprojectTeam5/AdminPage">Home</a></LI>
							<LI class="active"><a href="/CSPprojectTeam5/addHotel.jsp">Add Hotel</a></LI>
	...
	<DIV class="img-responsive bdy container-fluid mt inputForm row1">
		...
		<div class="row">
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form action="addScarletHotel" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="hotelCity">City Name: </label>
						<div id="hotelCity">
					...
					<div class="form-group">
						<label for="cancellation">Cancellation Policy: </label> <select
							...
							<option value="1">Before 7 days of Booking Date</option>
							<option value="2">After 7 days of Booking Date</option>
							<option value="3">One day ago of Booking Date</option>
						</select>
					</div>
					...
					<div class="form-group">
						<label for="rooms">Types of Rooms Available: </label> <input
							...
							required placeholder="Enter number" <%=roomTypes %> />
					</div>

					<div class="form-group">
						<label for="desc">Hotel Description: </label>
						<textarea class="form-control" id="desc" name="description" required placeholder="Enter Description about Scarlet Hotel"<%=hotelDescription %>></textarea>
					</div>

					<div class="form-group">
						<label for="featureDiv">Add Features: </label>
						<%
						if(request.getParameter("update") != null){
						...
						<div id="featureDiv">
							<input type="text" class="form-control"
								placeholder="Enter feature Name" name="f1" id="f1" />
						</div>
					...
					<div class="form-group">
						<label for="pics">Upload Some Images: </label>
						<input type="file"
