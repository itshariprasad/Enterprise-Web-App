...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <input type="radio" id="star5" name="rating" value="5" /><label for="star5" title="Aersome!">A;</label>
    <input type="radio" id="star4" name="rating" value="4" /><label for="star4" title="My good!">B;</label>
<input type="radio" id="star3" name="rating" value="3" /><label for="star3" title="Okay">C;</label>
    <input type="radio" id="star2" name="rating" value="2" /><label for="star2" title="D">D;</label>
<input type="radio" id="star1" name="rating" value="1" /><label for="star1" title="Always happens!">E;</label>
</div></li>

                    </ul>
                </li>
                <li>
                    <h3 class="bl" class="tlec"><input type="checkbox" /> Price Capacity</H3>
                    <ul class="sidebar-nav1">
                    <LI class="nm"><p>per night:</p></LI>
                    	<LI class="nm"><b>$100</b> <input type="range" /><b>$1000000</b></LI>

                    </ul>
                </li>
                <li>
                    <h4 class="tlec"><input type="checkbox" /> Available Rooms</h4>
                    <ul class="sidebar-nav1">
                ...
                <li>
                	<input class="ml btn btn-primary" type="submit" name="sortFilter" value="Apply!">
                </li>
            </ul>
       		</form>
        </div>
...
<%} %>
<h5 class="bl">and more.<h5 class="bl">
	...
	<DIV class="col-lg-3 col-md-4">
		<h3 class="bl"><b>Rooms available: <%=hotel.getTotalRooms() %></b1></H3>
