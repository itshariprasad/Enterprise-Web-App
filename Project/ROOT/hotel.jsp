				...
				<div class="col-lg-12">
					...
					<div class="row container-fluid">
						...
						<div class="col-lg-5">
							...
							<div class="row">
								<h3 class="bl cmt">Customer's Average Rating: <%=hotel.getRating() %>/5.0</H3>
							</div>
							<div class="row">
							...
							<div class="row bl container-fluid">
								<div class="col-md-2">
									<p class="text-right">Five star:</p>
								</div>
								<div class="col-md-6">
									<div class="progress">
							...
							<div class="row bl container-fluid">
								<div class="col-md-2">
									<p class="text-right">Four Star:</p>
								</div>
								<div class="col-md-6">
									<div class="progress">
										<div class="progress-bar progress-bar-success"
							...
							<div class="row bl container-fluid">
								<div class="col-md-2">
									<p class="text-right">Three star:</p>
								</div>
								<div class="col-md-6">
									<div class="progress">
										<div class="progress-bar progress-bar-success"
									...
									<DIV class="sortList">
										...
										<DIV class="ml row">
											...
											<DIV class="col-lg-4">
												...
												<div class="col-lg-12">
													<h3 class="h3">
														Price: $<%=room.getPrice() %>&nbsp;<small>per night</medium>
													</h3>
												</div>
												</div>
												<div class="row ml">
												...
												<div class="row ml3 ">
												<%if(emailId == null){ %>
													<a href="#signIn" data-toggle="modal" class="ml btn ">BOOK</a>
												<%} else{ %>
												<input class="ml btn " type="submit"
														value="BOOK" />
												<%} %>
												</div>
...
value="5" disabled <%=check5 %> /><label for="star5<%=k%>" title="On Effile tower!">&#9733;</label>
<input type="radio" id="star4<%=k%>" name="rating<%=k%>"
value="4" disabled <%=check4 %> /><label for="star4<%=k%>"
title="well good">&#9733;</label> <input type="radio"
...
disabled <%=check2 %> /><label for="star2<%=k%>" title="My bad">&#9733;</label>
