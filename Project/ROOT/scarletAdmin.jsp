...
<HEADER>
		...
		<DIV class="navbar navbar-inverse navbar-fixed-top">
			...
			<b><DIV class="container">
					...
					<H1>
						<a href="#" class="navbar-brand">Scarlet Hotels</a>
					</H1>
...
<%
int i=0;
ArrayList<ScarletHotelBean> hotels = (ArrayList<ScarletHotelBean>)session.getAttribute("hotels");
if (hotels == null){
...
for(ScarletHotelBean hotel : hotels) {
	i++;
%>
	<div class="bdy">
	<DIV class="sortList">
