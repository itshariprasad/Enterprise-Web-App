...
<DIV class="modal-footer">
	...
	<%
		File file = new File("C:\\apache-tomcat-7.0.34\\webapps\\CSPprojectTeam5\\WEB-INF\\classes\\deals\\DealMatches.txt");
		try{
...
MongoClient mongo1 = new MongoClient("localhost", 27017);
			...
			DB db1 = mongo1.getDB("Hotelpedia");
...
%>
	...
	<DIV class="col-lg-3 col-md-4">
		...
		<br/><br/>
  		<h3> <font color="#FF0000"> Sign In or Sign Up to view for further detals!</font></h3>
  	</DIV>
	</div>
	</DIV>
<%
