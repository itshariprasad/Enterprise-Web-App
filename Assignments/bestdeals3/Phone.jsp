...
<body class="phone">
  ...
  <li> <a href="Tv.jsp" class="tv"><font face = "Cambria" >TV</font></a></li>
	...
	<div id="contain">
		...
		<section id="desc">
		<img class = "img-disp" alt="phone" src="Images/Phone1.png" height="20%" width="100%">
			...
			BasicDBObject bdbo1 = new BasicDBObject();
									...
									bdbo2.append("field0", "Samsung S7 Edge")
											.append("field1", "700")
											...
											.append("field6", "0")
											.append("field7", "0")
											.append("field8", "samsungmob.jpg")
											.append("field9",
													System.currentTimeMillis());
									BasicDBObject bdbo3 = new BasicDBObject();
									bdbo3.append("field0", "Nexus 7")	
											.append("field1", "500")
											.append("field2", "Nexus")
											.append("field3", "Phone")
											.append("field4", "New")
											...
											.append("field6", "10")
											.append("field7", "20")
											.append("field8", "nexusmob.jpg")
											.append("field9",
													System.currentTimeMillis());
									BasicDBObject bdbo4 = new BasicDBObject();
									bdbo4.append("field0", "One plus 2")
											.append("field1", "400")
											.append("field2", "Other")
											.append("field3", "Phone")
											.append("field4", "New")
