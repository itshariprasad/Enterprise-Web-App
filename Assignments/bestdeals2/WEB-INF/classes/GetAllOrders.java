  ...
  public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException, IOException {
	...
	resultmetadata1 = rs3.getMetaData();
	 ...
	 while(rs3.next()){
		...
		String checkoutURL =
          response.encodeURL("/bestdeals2/EditOrder.html");	
	out.println
          ("" +
	...
	out.println("<TR><TD colspan='4'><FORM action='/bestdeals2/Deleteallorder'> Enter Order Id to Delete : <INPUT TYPE='TEXT' NAME='ordernumber' SIZE=10 VALUE=''>&nbsp&nbsp<INPUT TYPE='SUBMIT' VALUE='Delete Order'></FORM></TD></TR>" );
