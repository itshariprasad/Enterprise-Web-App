...
public class OrderAnalysis extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		pw.println("<html><head><link rel='stylesheet' type='text/css' href='StyleSheet.css'><title>Data Analytics</title></head>"
				...
				+ "	<option value='Toshiba LED 1080p HDTV'>Toshiba LED 1080p HDTV</option>"
				+ "	<option value='Sony 4K Ultra HD Smart LED TV'>Sony 4K Ultra HD Smart LED TV</option>"
				+ "	<option value='LG headphones'>LG headphones</option>"
